        ...
        <div className="md:col-span-3 space-y-12">
          ...
          <div className="rounded-3xl border border-slate-200 p-8 bg-white shadow-sm transition-all hover:shadow-md">
            ...
            <div className="space-y-6 max-w-md">
              ...
              <button className="h-11 px-8 rounded-xl bg-slate-900 text-white text-[13px] font-bold uppercase tracking-widest transition-all hover:bg-slate-800 active:scale-[0.98] shadow-lg shadow-slate-200 mt-2">
                Save Changes
              </button>
            </div>
          </div>
